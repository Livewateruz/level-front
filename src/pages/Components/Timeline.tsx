                        ...
                        <div className="sm:flex">
                            ...
                            <div className="flex-1">
                                ...
                                <div className="mt-4 sm:mt-7 mb-16">
                                    <svg
                                        className="text-white-dark ltr:mr-2.5 rtl:ml-2.5 inline-block align-text-bottom"
                                        width="20"
                                        height="20"
                                        viewBox="0 0 24 24"
                                        fill="none"
                            ...
                            <div className="flex-1">
                                ...
                                <div className="mt-4 sm:mt-7 mb-16">
                                    <svg
                                        ...
                                        fill="none"
                                        xmlns="http://www.w3.org/2000/svg"
                                        className="w-5 h-5 text-white-dark ltr:mr-2.5 rtl:ml-2.5 inline-block align-text-bottom"
                                    >
                                        <path
                            ...
                            <div className="flex-1">
                                ...
                                <div className="mt-4 sm:mt-7 mb-16">
                                    <svg
                                        ...
                                        fill="none"
                                        xmlns="http://www.w3.org/2000/svg"
                                        className="w-4.5 h-4.5 text-white-dark ltr:mr-2.5 rtl:ml-2.5 inline-block align-text-bottom"
                                    >
                                        <path
