                                                        ...
                                                        <ul className="text-sm font-medium">
                                                            <li>
                                                                <button type="button" onClick={() => setGroup('personal')}>
                                                                    <div className="w-2 h-2 rounded-full bg-primary ltr:mr-3 rtl:ml-3"></div>
                                                                    Personal
                                                                </button>
                                                            </li>
                                                            <li>
                                                                <button type="button" onClick={() => setGroup('work')}>
                                                                    <div className="w-2 h-2 rounded-full bg-warning ltr:mr-3 rtl:ml-3"></div>
                                                                    Work
                                                                </button>
                                                            </li>
                                                            <li>
                                                                <button type="button" onClick={() => setGroup('social')}>
                                                                    <div className="w-2 h-2 rounded-full bg-success ltr:mr-3 rtl:ml-3"></div>
                                                                    Social
                                                                </button>
                                                            </li>
                                                            <li>
                                                                <button type="button" onClick={() => setGroup('private')}>
                                                                    <div className="w-2 h-2 rounded-full bg-danger ltr:mr-3 rtl:ml-3"></div>
                                                                    Private
                                                                </button>
                                                            </li>
                                                        </ul>
                                                            ...
                                                            <div className="flex items-center whitespace-nowrap">
                                                                ...
                                                                <div className="ltr:mr-3 rtl:ml-3">
                                                                    <Tippy content="Star">
                                                                        ...
                                                                        >
                                                                            <svg
                                                                                className={mail.isStar ? 'fill-warning' : ''}
                                                                                width="20"
                                                                                height="20"
                                                                                viewBox="0 0 24 24"
                                                                                fill="none"
                                                                ...
                                                                <div className="ltr:mr-3 rtl:ml-3">
                                                                    <Tippy content="Important">
                                                                        <button
                                                                            type="button"
                                                                            className={`enabled:hover:text-primary disabled:opacity-60 flex items-center ${mail.isImportant ? 'text-primary' : ''}`}
                                                                            onClick={(e) => {
                                                                                e.stopPropagation();
                                                                        ...
                                                                        >
                                                                            <svg
                                                                                className={`rotate-90 ${mail.isImportant ? 'fill-primary' : ''}`}
                                                                                width="18"
                                                                                height="18"
                                                                                viewBox="0 0 24 24"
                                                                                fill="none"
                                        ...
                                        <div className="flex items-center justify-center space-x-3 rtl:space-x-reverse">
                                            ...
                                            <Tippy content="Reply">
                                                <button type="button" className="hover:text-info" onClick={() => openMail('reply', selectedMail)}>
                                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 rtl:hidden">
                                                    ...
                                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 ltr:hidden rtl:block">
