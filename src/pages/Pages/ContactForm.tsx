...
const ContactForm = () => {
    ...
    return (
        <div
            ...
            style={{
                backgroundImage: isDark ? `url('/assets/images/map-dark.svg')` : `url('/assets/images/map.svg')`,
            }}
        >
            <div className="panel sm:w-[480px] m-6 max-w-lg w-full">
                <h2 className="font-bold text-2xl mb-5">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-7 h-7 inline-block ltr:mr-3 rtl:ml-3 text-primary">
                        <path
                            opacity="0.5"
                ...
                <form className="space-y-4" onSubmit={submitForm}>
                    <div className="relative">
                        <span className="absolute ltr:left-2 rtl:right-2 top-2.5 text-primary">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <circle cx="12" cy="6" r="4" stroke="currentColor" strokeWidth="1.5" />
                                <ellipse opacity="0.5" cx="12" cy="17" rx="7" ry="4" stroke="currentColor" strokeWidth="1.5" />
                            </svg>
                        </span>
                        <input type="text" className="form-input ltr:pl-8 rtl:pr-8" placeholder="Name" />
                    </div>
                    <div className="relative">
                        <span className="absolute ltr:left-2 rtl:right-2 top-2.5 text-primary">
                        ...
                        <input type="email" className="form-input ltr:pl-8 rtl:pr-8" placeholder="Email" />
                    </div>
                    <div className="relative">
                        <span className="absolute ltr:left-2 rtl:right-2 top-2.5 text-primary">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-5 h-5">
                    ...
                    <div className="relative">
                        ...
                        <input type="text" className="form-input ltr:pl-8 rtl:pr-8" placeholder="Subject" />
                    </div>
                    <div className="relative">
                        <span className="absolute ltr:left-2 rtl:right-2 top-2.5 text-primary">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <textarea rows={4} className="form-textarea ltr:pl-8 rtl:pr-8 resize-none" placeholder="Message"></textarea>
                    </div>
